module.exports = {
  ...
  whitepaper: {
    ...
    items: [
      ...
      'Korean White Paper',
      'Chinese Simplified White Paper',
      'Chinese Traditional White Paper',
    ],
  },
  advisors: {
    title: 'Our Advisors',
    persons: [{
      name: 'Don Tapscott',
      description: ['Strategy Advisor', 'CEO of Tapscott Group'],
    }, {
      name: 'Ruslan Gavrilyuk',
      description: ['CryptoFinance Advisor', 'CEO &amp; Founder of TaaS Fund'],
    }, {
      name: 'Stephen Murphy',
      description: ['FinTech Advisor', 'CEO of Genesis Global Tech'],
    }, {
      name: 'Saul Hudson',
      description: ['Communications Advisor', 'GM at Thomson Reuters'],
    }, {
      name: 'Mohammad Al Sehli',
      description: ['MENA Advisor', 'CEO &amp; Founder of Arabian Chain'],
    }, {
      name: 'Dr. Moe Levin',
      description: ['Public Sector Advisor', 'CEO of Keynote'],
    }],
  },
  team: {
    title: 'Our Team',
  ...
  remodal: {
    ...
    steps: [{
      step1: {
        notice: [
          'Please note - contributions can be made using BTC or ETH.<br />Fiat contributions are accepted for amounts in excess of US$ 250,000.',
