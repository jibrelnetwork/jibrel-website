var i18nEN = {
  ...
  jnt: {
    ...
    charts: {
      ...
      items: [
        { title: '엔젤 라운', percents: '10', money: '20,000,000' },
        { title: '공개 프리세일', percents: '20', money: '40,000,000' },
        { title: '네트워크 런칭', percents: '40', money: '80,000,000' },
        { title: '팀', percents: '15', money: '30,000,000' },
        { title: '자문 및 파트너', percents: '10', money: '20,000,000' },
        { title: '바운티', percents: '5', money: '10,000,000' },
      ],
      code: 'JNT',
    },
  },
  ...
  advisors: {
    ...
    persons: [{
      name: 'Don Tapscott',
      description: ['전략 자문', 'Tapscott그룹의 CEO'],
    }, {
      name: 'Ruslan Gavrilyuk',
      description: ['가상화폐 금융 자문', 'TaaS펀드의 설립자이자 CEO'],
    }, {
      name: 'Stephen Murphy',
      description: ['핀테크 자문', 'Genesis Global Tech의 CEO'],
    }, {
      name: 'Saul Hudson',
      description: ['커뮤니케이션 자문', 'Thomson Reuters의 국장'],
    }, {
      name: 'Mohammad Al Sehli',
      description: ['중동통신 자문', 'Arabian Chain의 설립자이자 CEO'],
    }, {
      name: 'Dr. Moe Levin',
      description: ['공공 부문 자문', 'Keynote의 CEO'],
    }],
  },
  team: {
    title: '팀',
  ...
  remodal: {
    ...
    steps: [{
      step1: {
        notice: [
          '주의 - BTC 또는 ETH를 통해서만 참여할 수 있습니다.<br />법정화폐를 사용하여 참여할 경우US$ 250,000이상의 금액부터 참여할 수 있습니다.',
